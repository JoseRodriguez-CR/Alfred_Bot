...
public class AlfredQuotes {
    ...
    */
    public String dateAnnouncement() {
        // YOUR CODE HERE
        Date date = new Date();
        return "According your request, current date is: "+ date;
    }
    ...
    */
    public String respondBeforeAlexis(String conversation) {
        ...
        if(conversation.indexOf( "Alexis" )> -1){
            return "For sure sir, let me help with that before having you waiting a lot.";
        }
        if(conversation.indexOf( "Alfred" )> -1){
            return "At your service, since Alfred know that I'm going to find it as well!";
        }
        return "In that case, my presence is not required here, I shall retire rigth now!";
    }
    // NINJA BONUS
    // Write your own AlfredQuote method using any of the String methods you have learned!

    public String respondAlfredBotYelling(String conversation) {
        if(conversation.indexOf( "Good Work" )> -1){
            return "My glad to help you sir!!";
        }
        if(conversation.indexOf( "Bad Work" )> -1){
            return conversation.toUpperCase() + "Excuse sir, Am I wrong or you are blame on me?";
        }
        return "ENOUGH, THAT'S ALL FOR TODAY!";
    }
}
